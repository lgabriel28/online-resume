...
var HTMLheaderName = '<h1 class="header-role" id="name">%data%</h1>';
...
var HTMLgithub = '<li class="flex-item"><span class="orange-text">github</span><span class="white-text"><a class="github" href="%data%">%url%</a></span></li>';
...
var HTMLprojectImage = '<img class="img-responsive" src="%data%" height="350" width="400">';
